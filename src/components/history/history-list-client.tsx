                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="text-right shrink-0 select-none">
                      {item.pointsEarned !== null ? (
                        ...
                        <Badge variant="secondary" className="text-[10px] font-bold uppercase tracking-wider py-0.5 px-2.5 bg-amber-500/10 text-amber-500 border border-amber-500/20 rounded-lg animate-pulse">
                          En juego
                        </Badge>
                      )}
                    </div>
